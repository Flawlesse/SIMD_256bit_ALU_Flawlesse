...
HD_PWD='D:/STUDY/Verilog/SIMD_256bit_ALU_Flawlesse/Vivado Synthesis/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SIMD_ALU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SIMD_ALU.tcl
